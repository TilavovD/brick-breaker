...
public class Score implements ActionListener {
    ...
    Score(String[][] ls){
        label1.setText(Arrays.toString(ls[1]));
        label1.setBounds(100,100,500,25);
        label2.setText(Arrays.toString(ls[2]));
        label2.setBounds(100,150,500,25);
        label3.setText(Arrays.toString(ls[3]));
        label3.setBounds(100,200,500,25);
        label4.setText(Arrays.toString(ls[4]));
        label4.setBounds(100,250,500,25);
        label5.setText(Arrays.toString(ls[5]));
        label5.setBounds(100,300,500,25);
        label6.setText(Arrays.toString(ls[6]));
        label6.setBounds(100,350,500,25);
        label7.setText(Arrays.toString(ls[7]));
        label7.setBounds(100,400,500,25);
        label8.setText(Arrays.toString(ls[8]));
        label8.setBounds(100,450,500,25);
        label9.setText(Arrays.toString(ls[9]));
        label9.setBounds(100,500,500,25);
        label10.setText(Arrays.toString(ls[10]));
